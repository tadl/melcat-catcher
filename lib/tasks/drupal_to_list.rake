...
urls_and_list_ids = [{"name" => "New Music", "url" => "https://www.tadl.org/mobile/export/items/29/json", "list_id" => "19036"},
	...
	{"name" => "Adult Display", "url" => "https://www.tadl.org/mobile/export/items/45/json", "list_id" => "19041"},
	...
	{"name" => "TCFF Films", "url" => "https://www.tadl.org/mobile/export/items/165/json", "list_id" => "19046"},
	{"name" => "Met Opera", "url" => "https://www.tadl.org/mobile/export/items/286/json", "list_id" => "19047"},
	{"name" => "Youth New", "url" => "https://www.tadl.org/mobile/export/items/52/json", "list_id" => "19048"},
	{"name" => "Youth Display", "url" => "https://www.tadl.org/mobile/export/items/47/json", "list_id" => "19049"},
