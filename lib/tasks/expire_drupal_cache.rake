...
books_featured_fiction = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19039").read).take(6)
books_featured_nonfiction = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19040").read).take(6)
books_reviews = JSON.parse(open("https://www.tadl.org/export/reviews/Books/json").read)
books_adult_display = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19041").read).take(6)
books_adult_clubkits = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19042").read).take(6)
books_adult_business = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19043").read).take(6)
books_book_list = JSON.parse(open("https://www.tadl.org/export/node/json/80").read)
music_new = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19036").read).take(6)
music_hot = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19038").read).take(6)
...
videos_new = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19044").read).take(6)
videos_hot = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19045").read).take(6)
videos_tcff = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19046").read).take(6)
videos_met = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19047").read).take(6)
...
youth_display = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19049").read).take(6)
youth_new_books = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19048").read).take(6)
...
teens_new = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19050").read).take(6)
teens_manga = JSON.parse(open("http://mel-catcher.herokuapp.com/main/get_list.json?list_id=19051").read).take(6)
